...
| `screenshot-button-tooltip-text` | **Type**: `string`<br />**Default value**: `Take a Screenshot`<br />Tooltip text for the screenshot button.<br /><br />              |
...
| `rating-placeholder`            | **Type**: `string`<br />**Default value**: `How would you rate this page`<br />Placeholder for the feedback rating input.<br /><br />|

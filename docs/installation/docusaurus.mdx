...
PushFeedback collects user feedback directly from your website. This guide covers installation in a Docusaurus project using the official plugin.
...
You can change the widget's position, color, and more. Add any [configuration](../customization/layout.mdx) and [text](../customization/text.mdx) option to the plugin, formatted as camelCase.

    ...
    const placeholders = {
        en: {
          feedbackButtonText: "Feedback",
            ...
            screenshotButtonTooltipText: "Take a Screenshot",
        ...
        es: {
            ...
            screenshotButtonTooltipText: "Tomar una captura de pantalla",
    ...
    return (
        <div className="feedback-widget">
            <FeedbackButton
                ...
                screenshot-button-tooltip-text={screenshotButtonTooltipText}
